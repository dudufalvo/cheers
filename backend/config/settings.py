...
SECRET_KEY = 'django-insecure-%ix1&ehuy=pmbmg#^_&ffawr%k1i!zmln$0((4vzns-v9qr_al'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['0.0.0.0', 'localhost', '127.0.0.1'] # this is the host that Docker uses to run applications on the container
